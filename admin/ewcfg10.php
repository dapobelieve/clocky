...
define("EW_PROJECT_NAME", "clcoky", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{09DE0526-BAA4-4AF5-AFDE-AFBA7E888FCD}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'rylyh0LR1n0lYoAk', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/clcoky.css", TRUE); // Project stylesheet file name
...
define("EW_ADMIN_PASSWORD", "easy", TRUE); // Administrator password
...
define("EW_USER_PROFILE_SESSION_TIMEOUT", 1000, TRUE);
