...
class clogs_edit extends clogs {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// in
			$this->in->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->in->CurrentValue, 5), NULL, $this->in->ReadOnly);

			// out
			$this->out->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->out->CurrentValue, 5), NULL, $this->out->ReadOnly);
