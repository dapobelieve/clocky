...
<?php if ($logs->in->Visible) { // in ?>
		<td><span id="elh_logs_in" class="logs_in"><?php echo $logs->in->FldCaption() ?></span></td>
<?php } ?>
<?php if ($logs->out->Visible) { // out ?>
		<td><span id="elh_logs_out" class="logs_out"><?php echo $logs->out->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $logs_delete->RowCnt ?>_logs_in" class="control-group logs_in">
...
<span id="el<?php echo $logs_delete->RowCnt ?>_logs_out" class="control-group logs_out">
